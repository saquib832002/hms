 ...
 *
 * Added when mobile was opened to every role. Copied verbatim from
 * web/lib/types.ts — types.drift.test.ts asserts they stay identical, so
 * edit the web file and re-copy rather than changing these in place.
 * ───────────────────────────────────────────────────────────────────────── */
